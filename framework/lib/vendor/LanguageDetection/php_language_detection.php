...
function get_languages( $feature, $spare='', $httpAccessLanguage = '')
{
	// get the languages
	...
	if (!$httpAccessLanguage) {
		$httpAccessLanguage = $_SERVER["HTTP_ACCEPT_LANGUAGE"];
	}
	
	
	//check to see if language is set
	if ( isset( $httpAccessLanguage ) )
	{
		$languages = strtolower( $httpAccessLanguage );
